    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contents.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="title">{{ trans('cruds.content.fields.title') }}</label>
            ...
            <div class="form-group">
                <label for="description">{{ trans('cruds.content.fields.description') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.content.fields.description_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>{{ trans('cruds.content.fields.status') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.content.fields.status_helper') }}</span>
            </div>
            <div class="form-group">
