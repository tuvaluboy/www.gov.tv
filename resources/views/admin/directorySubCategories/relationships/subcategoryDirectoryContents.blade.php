...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-subcategoryDirectoryContents">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-subcategoryDirectoryContents:not(.ajaxTable)').DataTable({ buttons: dtButtons })
