...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.imageslide.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.imageslides.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('firstbutton') ? 'is-invalid' : '' }}" type="text" name="firstbutton" id="firstbutton" value="{{ old('firstbutton', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('firstbutton_link') ? 'is-invalid' : '' }}" type="text" name="firstbutton_link" id="firstbutton_link" value="{{ old('firstbutton_link', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('secondbutton') ? 'is-invalid' : '' }}" type="text" name="secondbutton" id="secondbutton" value="{{ old('secondbutton', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('secondbutton_link') ? 'is-invalid' : '' }}" type="text" name="secondbutton_link" id="secondbutton_link" value="{{ old('secondbutton_link', '') }}">
